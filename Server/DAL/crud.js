module.exports = {
    ...
    // readTraining: function (username, password, cb) {
    ...
    // //     db.close();
    // //     console.log("HRY")
    // //     console.log(JSON.stringify(result.curGames, null, 2))
    // //     //console.log(result)
    //
    ...
    //         };
    //
    //         console.log(JSON.stringify(competition.sponser,null,2))
    //         var newValues = {
    //             $set: {
